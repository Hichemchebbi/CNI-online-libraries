...
?>
	<form method="post" action="edit_book.php" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<th>ISBN</th>
				<td><input type="text" name="isbn" value="<?php echo $row['book_isbn'];?>" ></td>
			</tr>
			<tr>
				<th>Title</th>
			...
			<tr>
				<th>Categorie Id</th>
				<td><input type="text" name="categorie" value="<?php echo getcatgName($conn, $row['categorie_id']); ?>" required></td>
			</tr>
		</table>
